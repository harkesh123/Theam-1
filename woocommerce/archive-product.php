								...
								<?php if ( woocommerce_products_will_display() ) { ?>
									<div class="toolbar">
										<div class="toolbar-inner">  
											<div class="view-mode">
												<label><?php esc_html_e('View on', 'konado');?></label>
												<a href="#" class="grid <?php if($konado_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'konado' ); ?>"><i class="icon ion-grid"></i></a>
												<a href="#" class="list <?php if($konado_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'konado' ); ?>"><i class="icon ion-ios-list-outline"></i></a>
											</div>
											<?php
												/**
